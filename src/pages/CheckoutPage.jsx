          ...
          <div className="w-full flex items-start">
            <div className="w-1.8/3 mx-10 my-20 px-10  flex flex-col">
              ...
              <div className="w-full flex justify-between items-center gap-2 my-4">
                <label
                  htmlFor="delivery"
                  className="w-1/2 bg-yellow-50 px-10 py-5 rounded-2xl flex justify-start items-center gap-2 border-2 border-yellow-400 cursor-pointer"
                >
                  <input
                    type="radio"
                    id="delivery"
              ...
              <div className="flex flex-col justify-between itmes-start gap-3 mt-5">
                <div className="w-full flex flex-col ">
                  ...
                  <input
                    ...
                    className="w-full bg-white rounded-2xl border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-sm outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    type="text"
                    id="name"
                ...
                <div className="w-full flex flex-col">
                  ...
                  <input
                    ...
                    type="text"
                    id="add1"
                    placeholder="Building No. Block No. Apartment"
                  />
                </div>
                ...
                <div className="w-full flex flex-col">
                  ...
                  <select
                    className="w-full h-[40px] bg-white rounded-2xl border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-sm outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    name="country"
                    id="country"
                  >
                    <option name="country" value={shippingAddress.country}>
                      IN
                    </option>
                  </select>
                </div>
            ...
            <div className="w-1.2/3 mx-10 my-30 px-10">
              ...
              <div className="w-full flex flex-col gap-2">
                {item ? (
                  <div
                    key={item.id}
                    className="flex w-full justify-items-start gap-2 rounded-2xl border-2 border-yellow-600 mb-4 p-4"
                  >
                    <img
              ...
              <div className="flex w-full border border-gray-600 justify-between items-center my-4 px-6 py-4 rounded-2xl">
                ...
                <input
                  className="w-full apprence-none bg-transparent border-none outline-none px-4 m-0 shadow-none"
                  type="text"
              ...
              <button
                type="submit"
                className="w-full bg-yellow-400 py-2 rounded-2xl mb-5 cursor-pointer"
              >
                Order Now
              </button>
